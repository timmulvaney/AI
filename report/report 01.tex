...
\fancyhead[L]{\fontfamily{cmr}\selectfont\texttt{Question 1 - Visualization and analysis of the Palmer penguin dataset}} % Header left
\fancyhead[R]{\fontfamily{cmr}\selectfont\thepage} % Header right
\fancyfoot[L]{\fontfamily{cmr}\selectfont\texttt{emamtm0067.github.io} / \texttt{ematm0044.github.io}} % Footer left
\fancyheadoffset{0pt} % Adjust header width
