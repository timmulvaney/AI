...
\begin{wraptable}{r}{0.6\textwidth} % {alignment}{width}
  ...
  \vspace{0\baselineskip} % Remove space after the table
  \label{tab:results}
\end{wraptable} 
...
\begin{wrapfigure}{r}{0.47\textwidth} % {alignment}{width}
  \centering
...
\begin{figure}[!ht]
  ...
  \end{subfigure}
  \vspace{2\baselineskip} % Remove space before title
  \caption{Two-stage CVA approach with boundaries fitted using SVM 
