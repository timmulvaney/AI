...
def kmeans(local_df):
  ...
  # keep a copy of the dataframe to use locally   
  df = local_df
  ...
  # plot both the elbow and silhoutte on same graph

  # form both sets of data
  x1 = range(1, K+1)
  x2 = range(2, K+1)
  y1 = temp_inertias  # [1:]
  ...
  # Plot y1 data on primary y-axis
  ...
  # clusters matched to classes example plot
